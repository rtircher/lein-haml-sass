...
;; TODO remove ref to haml here
(tasks/def-lein-task haml "haml")

(tasks/def-hook compile-hook :haml :once)
(tasks/def-hook clean-hook   :haml :clean)
(tasks/def-hook deps-hook    :haml :deps)
